          ...
          {mode === "login" && (
            <>
              ...
              <button type="button" onClick={handleGoogleSignIn} disabled={isLoading}
                className="w-full h-12 rounded-lg border text-sm font-medium transition-all duration-200 hover:border-[hsl(0,0%,35%)] flex items-center justify-center gap-3 disabled:opacity-60"
                style={{ borderColor: "hsl(0, 0%, 18%)", color: "hsl(0, 0%, 85%)", background: "hsl(340, 40%, 9%)" }}>
