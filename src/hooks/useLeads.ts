...
const APP_STORAGE_KEYS = [STORAGE_KEY_LEADS, STORAGE_KEY_MEDIDAS, STORAGE_KEY_CONTRATOS, "mesbelle_user", "mesbelle_vestidos", "mesbelle_reservas", "mesbelle_producoes", "mesbelle_etapas", "mesbelle_logistica"];
